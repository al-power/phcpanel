...
echo "##########################################"
echo "#### Configurando y compilando cpanel ####"
echo "##########################################"

###############
echo -n "ingrese el correo administrador para el servidor:"
read mail
###############
###############
...
echo "CONTACTEMAIL $mail" >> /etc/wwwacct.conf

echo "Cambiando default DNSs..."
sed -i '/^NS\ .*/d' /etc/wwwacct.conf
sed -i '/^NS2\ .*/d' /etc/wwwacct.conf
echo "NS dns1.$HOST" >> /etc/wwwacct.conf
echo "NS2 dns2.$HOST" >> /etc/wwwacct.conf
...
sed -i 's/^globalspamassassin=.*/globalspamassassin=1/' /etc/exim.conf.localopts
...
# Integracion de RBL
mkdir /var/cpanel/rbl_info
#####
cd /var/cpanel/rbl_info

touch {barracudacentral,semdnsbl,sorbs,spamcannibal}.yaml

echo "---
"dnslists":
  - 'b.barracudacentral.org'
"name": 'barracudacentral'
"url": 'http://barracudacentral.org/rbl'" >> barracudacentral.yaml

echo "---
"dnslists":
  - 'bl.spameatingmonkey.net'
"name": 'semdnsbl'
"url": 'https://spameatingmonkey.com/services/SEM-BLACK'" >> semdnsbl.yaml

echo "---
"dnslists":
  - 'recent.spam.dnsbl.sorbs.net'
"name": 'sorbsrecent'
"url": 'http://www.sorbs.net/using.shtml'" >> sorbsrecent.yaml

echo "---
"dnslists":
  - 'dnsbl.sorbs.net'
"name": 'sorbs'
"url": 'http://www.sorbs.net/using.shtml'" >> sorbs.yaml

echo "---
"dnslists":
  - 'bl.spamcannibal.org'
"name": 'spamcannibal'
"url": 'http://spamcannibal.org'" >> spamcannibal.yaml

sed -i 's/^acl_barracudacentral_rbl=.*/acl_barracudacentral_rbl=1/' /etc/exim.conf.localopts
sed -i 's/^acl_semdnsbl_rbl=.*/acl_semdnsbl_rbl=1/' /etc/exim.conf.localopts
sed -i 's/^acl_sorbs_rbl=.*/acl_sorbs_rbl=1/' /etc/exim.conf.localopts
sed -i 's/^acl_sorbsrecent_rbl=.*/acl_sorbsrecent_rbl=1/' /etc/exim.conf.localopts
sed -i 's/^acl_spamcannibal_rbl=.*/acl_spamcannibal_rbl=1/' /etc/exim.conf.localopts

/scripts/buildeximconf

echo "Instalando paquetes PHP EasyApache 4..."
yum install -y ea-php55-php-curl ea-php55-php-fileinfo ea-php55-php-fpm ea-php55-php-gd ea-php55-php-iconv ea-php55-php-ioncube ea-php55-php-intl ea-php55-php-mbstring ea-php55-php-mcrypt ea-php55-php-pdo ea-php55-php-soap ea-php55-php-xmlrpc ea-php55-php-zip --skip-broken
sleep 5
yum install -y ea-php56-php-curl ea-php56-php-fileinfo ea-php56-php-fpm ea-php56-php-gd ea-php56-php-iconv ea-php56-php-ioncube ea-php56-php-intl ea-php56-php-mbstring ea-php56-php-mcrypt ea-php56-php-pdo ea-php56-php-soap ea-php56-php-xmlrpc ea-php56-php-zip ea-php56-php-opcache --skip-broken
sleep 5
yum install -y ea-php70-php-curl ea-php70-php-fileinfo ea-php70-php-fpm ea-php70-php-gd ea-php70-php-iconv ea-php70-php-intl ea-php70-php-mbstring ea-php70-php-mcrypt ea-php70-php-pdo ea-php70-php-soap ea-php70-php-xmlrpc ea-php70-php-zip ea-php70-php-ioncube6 ea-php70-php-opcache ea-php55-php-mysqlnd ea-php56-php-mysqlnd ea-php70-php-mysqlnd --skip-broken
sleep 5
yum -y install ea-apache24-mod_proxy_fcgi ea-php55-php-fpm ea-php56-php-fpm ea-php70-php-fpm libcurl-devel openssl-devel ea-php71 ea-php71-pear ea-php71-php-cli ea-php71-php-common ea-php71-php-curl ea-php71-php-devel ea-php71-php-exif ea-php71-php-fileinfo ea-php71-php-fpm ea-php71-php-ftp ea-php71-php-gd ea-php71-php-iconv ea-php71-php-intl ea-php71-php-litespeed ea-php71-php-mbstring ea-php71-php-mcrypt ea-php71-php-mysqlnd ea-php71-php-odbc ea-php71-php-opcache ea-php71-php-pdo ea-php71-php-posix ea-php71-php-soap ea-php71-php-xml ea-php71-php-zip ea-php71-runtime --skip-broken
sleep 5
yum -y install ea-php72 ea-php72-pear ea-php72-php-cli ea-php72-php-common ea-php72-php-curl ea-php72-php-devel ea-php72-php-exif ea-php72-php-fileinfo ea-php72-php-fpm ea-php72-php-ftp ea-php72-php-gd ea-php72-php-iconv ea-php72-php-intl ea-php72-php-litespeed ea-php72-php-mbstring ea-php72-php-mysqlnd ea-php72-php-opcache ea-php72-php-pdo ea-php72-php-posix ea-php72-php-soap ea-php72-php-xml ea-php72-php-zip ea-php72-runtime --skip-broken
sleep 5
yum -y install ea-php73 ea-php73-pear ea-php73-php-cli ea-php73-php-common ea-php73-php-curl ea-php73-php-devel ea-php73-php-exif ea-php73-php-fileinfo ea-php73-php-fpm ea-php73-php-ftp ea-php73-php-gd ea-php73-php-iconv ea-php73-php-intl ea-php73-php-litespeed ea-php73-php-mbstring ea-php73-php-mysqlnd ea-php73-php-opcache ea-php73-php-pdo ea-php73-php-posix ea-php73-php-soap ea-php73-php-xml ea-php73-php-zip --skip-broken
sleep 5
yum -y install ea-php55-php-bcmath ea-php56-php-bcmath ea-php70-php-bcmath ea-php71-php-bcmath ea-php72-php-bcmath ea-php73-php-bcmath ea-php73-runtime unixODBC php71-php-ioncube10 php72-php-ioncube10 --skip-broken
...
whmapi1 addpkg name=default featurelist=default quota=unlimited cgi=0 frontpage=0 language=es-latin maxftp=20 maxsql=20 maxpop=unlimited maxlists=0 maxsub=30 maxpark=30 maxaddon=0 hasshell=0 bwlimit=unlimited MAX_EMAIL_PER_HOUR=300 MAX_DEFER_FAIL_PERCENTAGE=30
